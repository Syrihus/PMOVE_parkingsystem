...
//		when(inputReaderUtil.readVehicleRegistrationNumber()).thenReturn("ABCDEF"); 
		...
		//THEN
		Assertions.assertEquals(ParkingType.BIKE, parkingService.getNextParkingNumberIfAvailable().getParkingType()); 
	...
	public void testParkingLotExit() {
        ...
        //THEN
        Assertions.assertEquals(strDate, strDate2); 
...
//	@Test
//	public void testConnectionDB() throws ClassNotFoundException, SQLException {
//		//GIVEN
//		DataBaseTestConfig dataBaseTestConfig = new DataBaseTestConfig(); 
//		//WHE
//		dataBaseTestConfig.getConnection(); 
//		//THEN
//		Assertions.assertNotEquals(Throwable.class.getTypeName(), dataBaseTestConfig.getConnection());
//		
//	}	
...
//		ticket = new Ticket(); 
//		Date exitDate = new Date(); 
//		ticket.setInTime(exitDate);
//		exitDate.setTime(exitDate.getTime() + (120*60*1000));
//		ticket.setOutTime(exitDate);
//		ticket.setParkingSpot(new ParkingSpot(1,ParkingType.CAR,false));
//		ticket.setPrice(3.2);
//		//WHEN
//		parkingService.processExitingVehicle(exitDate);
//		//THEN
//		Assertions.assertEquals(true, ticketDAO.updateTicket(ticket));
//	}
